...
def combate(escritorio, mango):
    turno= 0
    while escritorio.estar_vivo() and mango.estar_vivo():
        print("\nturno", turno)
        print(">>>accion de", escritorio.nombre, ":", sep="")
        escritorio.atacar(mango)
        print(">>>accion de", mango.nombre, ":", sep="")
        mango.atacar(escritorio)
        turno= turno+1
    if escritorio.estar_vivo():
       print("\nah ganado", escritorio.nombre)
    elif mango.estar_vivo():
        print("\nah ganado", mango.nombre)
    else:
        print("\nempate")
